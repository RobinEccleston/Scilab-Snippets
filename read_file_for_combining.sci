ModuleName="read_file_for_combining";
Version="0.01";
DateModified="31-Oct-2016";
DateOfCreation="31-Oct-2016";
Author="Rob Eccleston";
Description="Function to load both file parts from SE development spectrometer against reference data.";

mprintf("Loading " + ModuleName + " V" +  Version + ", Last Modified: " + DateModified + "\n");

function [AbsorptionProfile_a, AbsorptionProfile_b] = read_file_for_combining(bg_a, file_a, bg_b, file_b, reference_file)
